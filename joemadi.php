...
echo "\e[93m SCRIPT : Joemadi5758 \n";
echo "\e[93m Github: Joemadi \n";
echo "\n";
...
if ($register == false)
    ...
    if ($verif == false)
        ...
        if ($claim == false)
            ...
            echo "\e[300m[!]".$voucher."\n";
            sleep(3);
            echo "\e[400m[!] Trying to redeem Voucher :  GOFOOD022620A !\n";
            sleep(3);
            goto next;
            }
            else{
                echo "\e[300m[+] ".$claim."\n";
                sleep(3);
                echo "\e[400m[!] Trying to redeem Voucher : COBAGORIDE !\n";
                sleep(3);
                goto ride;
            }
            next:
